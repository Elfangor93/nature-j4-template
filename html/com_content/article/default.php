...
<script>
  var callback = function(){
    ...
    if(document.querySelectorAll('.com-content-article__body > div:not([class*="pswp"])'))
    {
      elem      = document.querySelectorAll('.com-content-article__body > div:not([class*="pswp"])');
      last_elem = elem[elem.length - 1];
    }
